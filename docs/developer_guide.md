...
Your provider module **must** contain a class named `Provider` inheriting from the [Provider]
...
You should review the "Provider conventions" section of the [technical workbook] to ensure
...
providers, they are stored in the [tests/fixtures/cassettes/] sub-folders.
...
`_test_parameters_override()` method. See [test_powerdns.py] for an example.
...
Finally you should add yourself to the [CODEOWNERS file], in the root of the repo.
It's my way of keeping track of who to ping when I need updated recordings as the
test suites expand & change.

[cloudflare.py]: https://github.com/dns-lexicon/dns-lexicon/blob/main/src/lexicon/providers/cloudflare.py
[codeowners file]: https://github.com/dns-lexicon/dns-lexicon/blob/master/CODEOWNERS
[provider]: https://github.com/dns-lexicon/dns-lexicon/blob/main/src/lexicon/interfaces.py
[technical workbook]: ./technical_workbook.html
[test_powerdns.py]: https://github.com/dns-lexicon/dns-lexicon/blob/5ee4d16f9d6206e212c2197f2e53a1db248f5eb9/lexicon/tests/providers/test_powerdns.py#L19
[tests/fixtures/cassettes/]: https://github.com/dns-lexicon/dns-lexicon/tree/main/tests/fixtures/cassettes
